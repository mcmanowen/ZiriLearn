...
public class FoodGameScene extends BaseScene  implements IOnSceneTouchListener, IOnAreaTouchListener  {
    ...
    static final String[] textImgsFr = {"orange","carottes","pomme", "pommes de terre","bananes","poires","brocholi","raisins","pêches","mandarine","abricot","aubergine","citron","ananas","piment rouge","olives","poivrons","ciboulette","cerises","maïs","pastèque","avocat","cacahuetes","pistaches","amandes","noix de cajou","oignon","tomate"};
    static final String[] textImgsFrRead = {"orange","carottes","pomme", "pommes de terre","banane","poire","brokoli","raisins","pêches","mandarine","abricot","aubergine","citron","ananas","piment rouge","olives","poivrons","ciboulette","cerises","mayisse","pastèque","avocat","cacahuetes","pistaches","amandes","noix de cajou","onion","tomate"};
    static final String[] textImgsEn = {"orange","carrots","apples", "potatoes","bananas","pears","brocholi","grapes","peaches","mandarin","apricot","eggplant","lemon","pineapple","red chili peppers","olives","bell peppers","chives","cherries","corn","watermelon","avocado","peanuts","pistachios","almonds","cashew nut","onion","tomatoes"};
...
*/
	...
	private void goMenu() {
		...
		detachChild(gamecompleteHUD);
		pageCounter = 100;
		resourcesManager.unloadFoodGameResources();
		//disposeScene();
		}catch(Exception ex){
			ex.printStackTrace();
		}	
	...
	private void readQuestion(int simg){
		...
		if(muteOrNot==false){
			...
			resourcesManager.tts.speak("where is , "+textImgsEn[simg],TextToSpeech.QUEUE_FLUSH,null);
			}
		}else{}
	}
