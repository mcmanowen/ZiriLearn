...
public class AnimalLearnScene extends BaseScene implements IOnSceneTouchListener, IOnAreaTouchListener  {
    ...
    static final String[] textImgsFrRead = {"oursse","cha","cock", "chien","dauphin","canard","aigle","éléphant","gazelle","oie","poule","cheval","lion", "singe","panthère","perroquet","rhinocérosse","serpent","écureuil","cygne","tigre","pan","giraffe","lionne","lou","koala","léopard","sanglier","renard","mouton","merle","lapin","faucon","cerre","ane","flamant","lézard","mouètte","mante religieuse","zébre","cigogne","la mésange bleue","biche","chardonneret","crabe","taureau","ours polaire","gorille","chamois"};
	...
	public void onBackKeyPressed() {
		...
		resourcesManager.unloadAnimalLearnResources();
        PageCounter = 100;
	...
	private void readimgName() {
		...
		*/
		...
		if(muteOrNot==false){
			...
			resourcesManager.tts.speak(textImgsEnRead[imgNumber],TextToSpeech.QUEUE_FLUSH,null);
			}
		}else{}
