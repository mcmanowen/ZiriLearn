...
public class BallGame4Scene extends BaseScene implements IOnSceneTouchListener, IOnAreaTouchListener {
	...
	*/
	...
	Rectangle stadiumleftNetleftBar,stadiumleftNetrightBar,stadiumrightNetleftBar,stadiumrightNetrightBar;
	Rectangle stadiumtop,stadiumbottom;
	//-- collisions -------------------------------
    ...
    static int bodyCount=0;
	 ...
	 //-------------------------------------------------	
		...
		private CameraScene pauseScene,winScene,goMenuScene,replaymatchScene;
	...
	public void createScene() {
		...
		*/
		...
		initVariables(0,false,false,5,0,0,0,0,muteOrNot,soundsOrNot,100,false,false,false,false);
	
		initLevelVariables(6,1,1,0,1,0,1,1);
		...
		replaymatchScene = new CameraScene(camera);
		// Make the 'WIN'-label centered on the camera. 
		final Sprite replaymatchSprite = new Sprite(centerX, centerY, resourcesManager.emptyWindowTR, vbom);
		replaymatchScene.attachChild(replaymatchSprite);
		// Makes the paused Game look through. 
		replaymatchScene.setBackgroundEnabled(false);
    	
		final TiledSprite replaymatchyes;
		replaymatchyes = new TiledSprite(500, 150, resourcesManager.btYesTR, vbom){
		...
		replaymatchyes.setCurrentTileIndex(0);
		replaymatchScene.attachChild(replaymatchyes);

		replaymatchScene.registerTouchArea(replaymatchyes);
		
		
		final TiledSprite replaymatchno;
		replaymatchno = new TiledSprite(300, 150, resourcesManager.btNoTR, vbom){
		...
		replaymatchno.setCurrentTileIndex(0);
		replaymatchScene.attachChild(replaymatchno);

		replaymatchScene.registerTouchArea(replaymatchno);
		
		endmatchHUD = new HUD();
		endmatchText = new Text(400,320, resourcesManager.mBitmapFont, "abcdefghijklmnopqrstuvwxyzabcdefgfdfdfdfdsfdsfsdfsdfsdf", vbom);
		endmatchText.setSkewCenter(0,0);    						
		endmatchText.setText("");        
		//quitOrNotText.setText("Do You Really Want To Exit !"); 
		endmatchHUD.attachChild(endmatchText); 
		
		replaymatchText = new Text(400,230, resourcesManager.mBitmapFont, "abcdefghijklmnopqrstuvwxyzabcdefgfdfdfdfdsfdsfsdfsdfsdf", vbom);
		replaymatchText.setSkewCenter(0,0);    						
		replaymatchText.setText("");    
		endmatchHUD.attachChild(replaymatchText);
		
        camera.setHUD(endmatchHUD); 
        replaymatchScene.attachChild(endmatchHUD);
        ...
        */
        ...
        usernameA=((GameActivity) activity).getPreference("localplayer", "Guest");
        usernameB=((GameActivity) activity).getPreference("visitorplayer", "Computer");
        gameHUD = new HUD();
        ...
        usernameAText.setText(usernameA);
        ...
        usernameBText.setText(usernameB);
...
*/
		...
		//final AnimatedSprite balls;
		 ...
		 //////////////////////////////////////////////////////////////////////////////////////////////
			...
			*/
			...
			final FixtureDef BoxBodyFixtureLeftFoot =PhysicsFactory.createFixtureDef(10f, 0.5f, 0.5f);
                ...
                {		
                    if (isTouchedFlagLeft){
                    	...
                    	//BoxBodyFixtureLeftFoot.density=10;
                    	/*
                    	try{
                    	...
                    	if(mMouseJointActiveLeftFoot == null) {
         					...
         					try{   
         						...
         						mMouseJointActiveLeftFoot = createMouseJointLeftFoot(this, xleftPos, yleftPos);
                    	...
                    	//BoxBodyFixtureLeftFoot.density=0;                    	
                    	...
                    	if(mMouseJointActiveLeftFoot != null) {
         					physicsWorld.destroyJoint(mMouseJointActiveLeftFoot);
         					physicsWorld.destroyBody(mGroundBodyLeftFoot);
         					mMouseJointActiveLeftFoot = null;
         					}
                    }   
			...
			leftFootbody = PhysicsFactory.createCircleBody(physicsWorld, leftFoot, BodyType.KinematicBody, BoxBodyFixtureLeftFoot);
			...
			final FixtureDef BoxBodyFixtureRightFoot =PhysicsFactory.createFixtureDef(10f, 0.5f, 0.5f);
			...
			rightFootbody = PhysicsFactory.createCircleBody(physicsWorld, rightFoot, BodyType.KinematicBody, BoxBodyFixtureRightFoot);
            ...
            netright = new AnimatedSprite((camera.getWidth()-5-resourcesManager.netrightTR.getWidth()/2),226,resourcesManager.netrightTR,engine.getVertexBufferObjectManager());
         ...
         // net left 
           // final FixtureDef NET_FIXTURE_DEF = PhysicsFactory.createFixtureDef(0f,0f, 0f);
            ...
            netleft = new AnimatedSprite((5+resourcesManager.netleftTR.getWidth()/2),226,resourcesManager.netleftTR,engine.getVertexBufferObjectManager());
			...
			stadiumleftNetleftBar = new Rectangle(45,366 ,2 , 141,vbom);
			//staticRect.setUserData(staticBody);
			stadiumleftNetleftBar.setColor(1f, 1f, 1f);
            //staticRect.setAlpha(0.5f);
            attachChild(stadiumleftNetleftBar);
            staticBody = PhysicsFactory.createBoxBody(physicsWorld,stadiumleftNetleftBar,
                    BodyType.StaticBody, boxFixtureDef);
            //staticBody.setUserData(staticBody);
            physicsWorld.registerPhysicsConnector(new PhysicsConnector(
            		stadiumleftNetleftBar, staticBody));
			
            
			stadiumleftNetrightBar = new Rectangle(45,85,2,144,vbom);
			//staticRect.setUserData(staticBody);
			stadiumleftNetrightBar.setColor(1f, 1f, 1f);
            //staticRect.setAlpha(0.5f);
            attachChild(stadiumleftNetrightBar);
            staticBody = PhysicsFactory.createBoxBody(physicsWorld,stadiumleftNetrightBar,
                    BodyType.StaticBody, boxFixtureDef);
            //staticBody.setUserData(staticBody);
            physicsWorld.registerPhysicsConnector(new PhysicsConnector(
            		stadiumleftNetrightBar, staticBody));
            
            
			stadiumrightNetleftBar = new Rectangle(754,366 ,2 , 141,vbom);
			//staticRect.setUserData(staticBody);
			stadiumrightNetleftBar.setColor(1f, 1f, 1f);
            //staticRect.setAlpha(0.5f);
            attachChild(stadiumrightNetleftBar);
            staticBody = PhysicsFactory.createBoxBody(physicsWorld,stadiumrightNetleftBar,
                    BodyType.StaticBody, boxFixtureDef);
            //staticBody.setUserData(staticBody);
            physicsWorld.registerPhysicsConnector(new PhysicsConnector(
            		stadiumrightNetleftBar, staticBody));
            
		    
		    
            stadiumrightNetrightBar = new Rectangle(754,85,2,144,vbom);
			//staticRect.setUserData(staticBody);
            stadiumrightNetrightBar.setColor(1f, 1f, 1f);
            //staticRect.setAlpha(0.5f);
            attachChild(stadiumrightNetrightBar);
            staticBody = PhysicsFactory.createBoxBody(physicsWorld,stadiumrightNetrightBar,
                    BodyType.StaticBody, boxFixtureDef);
            //staticBody.setUserData(staticBody);
            physicsWorld.registerPhysicsConnector(new PhysicsConnector(
            		stadiumrightNetrightBar, staticBody));
            
            
            stadiumtop = new Rectangle(400, 437, 710, 2,vbom);
			//staticRect.setUserData(staticBody);
            stadiumtop.setColor(1f, 1f, 1f);
            //staticRect.setAlpha(0.5f);
            attachChild(stadiumtop);
            staticBody = PhysicsFactory.createBoxBody(physicsWorld,stadiumtop,
                    BodyType.StaticBody, boxFixtureDef);
            //staticBody.setUserData(staticBody);
            physicsWorld.registerPhysicsConnector(new PhysicsConnector(
            		stadiumtop, staticBody));
            
            stadiumbottom = new Rectangle(400,14,710, 2,vbom);
			//staticRect.setUserData(staticBody);
            stadiumbottom.setColor(1f, 1f, 1f);
            //staticRect.setAlpha(0.5f);
            attachChild(stadiumbottom);
            staticBody = PhysicsFactory.createBoxBody(physicsWorld,stadiumbottom,
                    BodyType.StaticBody, boxFixtureDef);
            //staticBody.setUserData(staticBody);
            physicsWorld.registerPhysicsConnector(new PhysicsConnector(
            		stadiumbottom, staticBody));
            ...
            */
            ...
            starsleft = new AnimatedSprite((8+resourcesManager.netleftTR.getWidth()/2),230,resourcesManager.starsTR,engine.getVertexBufferObjectManager());
            starsleft.animate(200);
            starsleft.setVisible(showStarsleft);
			this.attachChild(starsleft);
			
			starsright = new AnimatedSprite((camera.getWidth()-8-resourcesManager.netrightTR.getWidth()/2),230,resourcesManager.starsTR,engine.getVertexBufferObjectManager());
            ...
            physicsWorld.setContactListener(new ContactListener(){
				...
				public void beginContact(Contact contact) {
					...
					else if (!bodyA.equals(staticBody))
					{
					...
					if(isBodyContacted(leftFootbody,contact)){
	  					  //leftFootbody.setLinearVelocity(contact.getWorldManifold().getNormal());
	  						if (contact.getFixtureA().getBody()==leftFootbody){
	  							//showStarsleft=true;
	  							//starsleft.setVisible(showStarsleft);
	  							contact.getFixtureB().getBody().applyLinearImpulse(contact.getWorldManifold().getNormal().mul(150), contact.getFixtureB().getBody().getWorldCenter());
	  						}else{
	  							//showStarsleft=true;
	  							//starsleft.setVisible(showStarsleft);
	  							contact.getFixtureA().getBody().applyLinearImpulse(contact.getWorldManifold().getNormal().mul(150), contact.getFixtureA().getBody().getWorldCenter());
	  						}
	  					}else{
	  						//showStarsleft=false;
	  						//starsleft.setVisible(showStarsleft);
	...
	private void goMenu() {
		...
		resourcesManager.unloadBallGame4Resources();
		//disposeScene();
		}catch(Exception ex){
			ex.printStackTrace();
		}	
	...
	*/
	...
	private void updScoreA(int i) {
			...
			scoreAText.setText(""+scoreA);
			playParticles(330,465,3);	
			if(nbObjectsInScene<1){
				
				if (levelID<2){
					if (localLanguage==0){
					levelCompleteText.setText("prochain round !");
					}else{
					levelCompleteText.setText("next round !");	
					}
					...
					if (scoreA>scoreB){	
						endmatchText.setText(usernameA+victoire);
						}else if (scoreB>scoreA){
						endmatchText.setText(usernameB+victoire);	
						}else {
							if (localLanguage==0){
								endmatchText.setText("Match nul !");	
							}else{
								endmatchText.setText("Draw. no body win !");
							}
						}
					if (localLanguage==0){
					replaymatchText.setText("Voulez vous rejouer ?");	
					}else{
					replaymatchText.setText("Do You Want To Replay ?");	
					}
					replayMatchScene();	
					}
			}
	...
	private void replayMatchScene() {
		// TODO Auto-generated method stub
		gameState = STATE_NEXTLEVEL;

		this.setChildScene(replaymatchScene, false, true, true);
		try{	
