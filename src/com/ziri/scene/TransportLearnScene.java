...
public class TransportLearnScene extends BaseScene implements IOnSceneTouchListener, IOnAreaTouchListener  {
    ...
    static final String[] textImgsFr = {"bus","voiture","voiture de sport", "camion","voiture","moto de neige","pickup","bus","moto","tracteur","fourgon","bateau","avionde guerre", "train","quad","clark","camion de pompier","vélo","voiture de police","avion","tigre","loup","giraffe","aigle","chat","papillon","chiot","éléphant","gazelle","dauphin","oie","canard","cheval","singe","poule","perroquet","panthère","lionne","loup","écureuil","tigre","cygne","giraffe"};
    static final String[] textImgsFrRead = {"busse","voiture","voiture de sport", "camion","voiture","moto de neige","pickeuppe","busse","moto","tracteur","fourgon","bateau","avion de guerre", "train","kwade","clark","camion de pompier","vélo","voiture de police","avion","tigre","loup","giraffe","aigle","cha","papillon","chio","éléphant","gazelle","dauphin","oie","canard","cheval","singe","poule","perroquet","panthère","lionne","loup","écureuil","tigre","cygne","giraffe"};
    static final String[] textImgsEn = {"bus","car","sport car", "truck","car","snowbike","pickup","bus","moto","tractor","van","boat","war plane", "train","quad","clark","fire truck","bike","police car","plane","tiger","wolf","giraffe","eagle","cat","butterfly","dog","elephant","gazelle","dolphin","goose","duck","horse","monkey","hen","parrot","panther","lion","wolf","squirrel","tiger","swan","giraffe"};
	...
	public void onBackKeyPressed() {
		...
		resourcesManager.unloadTransportLearnResources();
        PageCounter = 100;
