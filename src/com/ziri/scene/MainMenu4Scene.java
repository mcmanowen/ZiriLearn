...
public class MainMenu4Scene extends BaseScene implements IOnMenuItemClickListener {
    ...
    //--texts
    static final String[] textsFr = {"+4 ans : leçons","+4 ans : jeux","Options","Profil","Jeux","Leçons","Animaux","Musique","Aliments","Formes","Drapeaux","Transport","ziri match"};
    //static final String[] textsFrRead = {"Choisissez Un Profile SVP !","0-2 ans","2-4 ans", "+4 ans"};
    static final String[] textsEn = {"+4 years : learn","+4 years : games","Options","Profile","Games","Learn","Animals","Music","Food","Shapes","Flags","Transport","ziri match"};
	...
	private final int MENU_TRANSPORTLEARN = 21;
	...
	private final int MENU_TRANSPORTPLAY = 20;
	...
	private final int TXT_ANIMAL = 6;
	private final int TXT_MUSIC = 7;
	private final int TXT_FOOD = 8;
	private final int TXT_SHAPE = 9;
	private final int TXT_FLAG = 10;
	private final int TXT_TRANSPORT = 11;
	private final int TXT_GAME = 12;
...
private void createMenuChildScene() {
	...
	*/
	...
	/*
	final Text bitmapTextAlphabetLearn = new Text(100, 330, resourcesManager.mBitmapFont, "Alphabets", vbom);		
	menuChildScene.attachChild(bitmapTextAlphabetLearn);
					
	final Text bitmapTextNumberLearn = new Text(280, 330, resourcesManager.mBitmapFont, "Numbers", vbom);
	menuChildScene.attachChild(bitmapTextNumberLearn);
	
	final Text bitmapTextColorLearn = new Text(460, 330, resourcesManager.mBitmapFont, "Colors", vbom);		
	menuChildScene.attachChild(bitmapTextColorLearn);
	
	final Text bitmapTextGameLearn = new Text(460, 16, resourcesManager.mBitmapFont, "Game", vbom);		
	menuChildScene.attachChild(bitmapTextGameLearn);
	*/
	final Text bitmapTextAnimalLearn = new Text(100, 250, resourcesManager.mBitmapFont, getText(TXT_ANIMAL), vbom);		
	menuChildScene.attachChild(bitmapTextAnimalLearn);
	
	final Text bitmapTextMusicalinstLearn = new Text(290, 250, resourcesManager.mBitmapFont, getText(TXT_MUSIC), vbom);		
	menuChildScene.attachChild(bitmapTextMusicalinstLearn);	
	
	final Text bitmapTextFoodLearn = new Text(480, 250, resourcesManager.mBitmapFont, getText(TXT_FOOD), vbom);		
	menuChildScene.attachChild(bitmapTextFoodLearn);
		
	final Text bitmapTextShapeLearn = new Text(100, 64, resourcesManager.mBitmapFont, getText(TXT_SHAPE), vbom);		
	menuChildScene.attachChild(bitmapTextShapeLearn);
	
	final Text bitmapTextFlagLearn = new Text(290, 64, resourcesManager.mBitmapFont, getText(TXT_FLAG), vbom);		
	menuChildScene.attachChild(bitmapTextFlagLearn);
		
	final Text bitmapTextTransportLearn = new Text(480, 64, resourcesManager.mBitmapFont, getText(TXT_TRANSPORT), vbom);		
	menuChildScene.attachChild(bitmapTextTransportLearn);
	...
	//bitmapTextColorLearn.setColor(Color.YELLOW);
	//bitmapTextGameLearn.setColor(Color.GREEN);
	bitmapTextAnimalLearn.setColor(Color.RED);
	bitmapTextMusicalinstLearn.setColor(Color.GREEN);	
	bitmapTextFoodLearn.setColor(Color.YELLOW);
	bitmapTextShapeLearn.setColor(Color.YELLOW);
	bitmapTextFlagLearn.setColor(Color.RED);	
	bitmapTextTransportLearn.setColor(Color.GREEN);
	bitmapTextOptions.setColor(Color.CYAN);
	bitmapTextProfile.setColor(Color.CYAN);
	bitmapTextPlay.setColor(Color.CYAN);
	
	//final IMenuItem alphabetlearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_ALPHABETLEARN, resourcesManager.btAlphabetIconTR, vbom), 1f, .8f);
	//final IMenuItem numberlearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_NUMBERLEARN, resourcesManager.btNumbersIconTR, vbom), 1f, .8f);
	...
	final IMenuItem transportMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_TRANSPORTLEARN, resourcesManager.btTransportlearnIconTR, vbom), 1f, .8f);
	...
	menuChildScene.addMenuItem(transportMenuItem);
	...
	//alphabetlearnMenuItem.setPosition(100, 408);
	//numberlearnMenuItem.setPosition(280, 408);
	//colorlearnMenuItem.setPosition(460, 408);	
	//ballgameMenuItem.setPosition(460, 92);
	animallearnMenuItem.setPosition(100, 328);
	musicalinstlearnMenuItem.setPosition(290, 328);
	foodlearnMenuItem.setPosition(480, 328);	
	shapelearnMenuItem.setPosition(100, 140);
	flaglearnMenuItem.setPosition(290, 140);
	transportMenuItem.setPosition(480, 140);	
...
private void createMenuPlayChildScene() {
	...
	*/
	...
	/*
	final Text bitmapTextAnimalLearn = new Text(100, 192, resourcesManager.mBitmapFont, getText(TXT_ANIMAL), vbom);		
	menuPlayChildScene.attachChild(bitmapTextAnimalLearn);
	
	final Text bitmapTextMusicalinstLearn = new Text(290, 192, resourcesManager.mBitmapFont, getText(TXT_MUSIC), vbom);		
	menuPlayChildScene.attachChild(bitmapTextMusicalinstLearn);	
	
	final Text bitmapTextFoodLearn = new Text(480, 192, resourcesManager.mBitmapFont, getText(TXT_FOOD), vbom);		
	menuPlayChildScene.attachChild(bitmapTextFoodLearn);
	*/	
	final Text bitmapTextShapeLearn = new Text(100, 250, resourcesManager.mBitmapFont, getText(TXT_SHAPE), vbom);		
	menuPlayChildScene.attachChild(bitmapTextShapeLearn);
	
	final Text bitmapTextFlagLearn = new Text(290, 250, resourcesManager.mBitmapFont, getText(TXT_FLAG), vbom);		
	menuPlayChildScene.attachChild(bitmapTextFlagLearn);
		
	final Text bitmapTextTransportLearn = new Text(480, 250, resourcesManager.mBitmapFont, getText(TXT_TRANSPORT), vbom);		
	menuPlayChildScene.attachChild(bitmapTextTransportLearn);
	...
	*/
	...
	//final IMenuItem alphabetlearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_ALPHABETPLAY, resourcesManager.btAlphabetIconTR, vbom), 1f, .8f);
	//final IMenuItem numberlearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_NUMBERPLAY, resourcesManager.btNumbersIconTR, vbom), 1f, .8f);
	//final IMenuItem colorlearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_COLORPLAY, resourcesManager.btColorlearnIconTR, vbom), 1f, .8f);
	final IMenuItem ballgameMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_BALLGAME, resourcesManager.btGame4IconTR, vbom), 1f, .8f);
	/*
	...
	*/
	final IMenuItem shapelearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_SHAPEPLAY, resourcesManager.btShapeplayIconTR, vbom), 1f, .8f);
	final IMenuItem flaglearnMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_FLAGPLAY, resourcesManager.btFlagplayIconTR, vbom), 1f, .8f);
	final IMenuItem transportMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_TRANSPORTPLAY, resourcesManager.btTransportplayIconTR, vbom), 1f, .8f);
	final IMenuItem optionsMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_OPTIONS, resourcesManager.btOptionsIconTR, vbom), 1f, .8f);
	final IMenuItem profileMenuItem = new ScaleMenuItemDecorator(new SpriteMenuItem(MENU_PROFILE, resourcesManager.btProfileIconTR, vbom), 1f, .8f);
	...
	*/
	...
	menuPlayChildScene.addMenuItem(transportMenuItem);
	...
	/*
	animallearnMenuItem.setPosition(100, 270);
	musicalinstlearnMenuItem.setPosition(290, 270);
	foodlearnMenuItem.setPosition(480, 270);
	*/	
	shapelearnMenuItem.setPosition(100, 328);
	flaglearnMenuItem.setPosition(290, 328);
	transportMenuItem.setPosition(480, 328);	
	optionsMenuItem.setPosition(700, 428);
	profileMenuItem.setPosition(700, 270);
	playMenuItem.setPosition(700, 112);
...
public SceneType getSceneType() {
	return SceneType.SCENE_MAINMENU4;
}
...
public boolean onMenuItemClicked(MenuScene pMenuScene, IMenuItem pMenuItem,
	...
	switch(pMenuItem.getID())
	{
		...
		case MENU_BALLGAME:
			...
			SceneManager.getInstance().loadBallGame4Scene(engine);				
			return true;
		...
		case MENU_MUSICALINSTLEARN:	
			...
			pauseMusic();
			resourcesManager.setIdMenu(0);
			SceneManager.getInstance().loadMusicinstrLearnScene(engine);
			return true;
		case MENU_FOODLEARN:	
			playSelectSound();
			pauseMusic();
			resourcesManager.setIdMenu(0);
			SceneManager.getInstance().loadFoodLearnScene(engine);
			return true;
		case MENU_SHAPELEARN:	
			playSelectSound();
			pauseMusic();
			resourcesManager.setIdMenu(0);
			SceneManager.getInstance().loadShapeLearnScene(engine);
			return true;
		case MENU_FLAGLEARN:	
			playSelectSound();
			pauseMusic();
			resourcesManager.setIdMenu(0);
			SceneManager.getInstance().loadFlagLearnScene(engine);
			return true;
		case MENU_TRANSPORTLEARN:	
			playSelectSound();
			pauseMusic();
			resourcesManager.setIdMenu(0);
			SceneManager.getInstance().loadTransportLearnScene(engine);
			return true;
		//-- PLAY SCENES --------------------------------------------
			
		case MENU_ALPHABETPLAY:
			//playSelectSound();
			//SceneManager.getInstance().loadAlphabetPlayScene(engine);
			return true;
		case MENU_NUMBERPLAY:
			//playSelectSound();
			//SceneManager.getInstance().loadNumberPlayScene(engine);
			return true;		
		case MENU_COLORPLAY:
			//playSelectSound();
		...
		case MENU_SHAPEPLAY:
			...
			pauseMusic();
			resourcesManager.setIdMenu(1);
			SceneManager.getInstance().loadShapeGameScene(engine);
			return true;
		case MENU_FLAGPLAY:	
			playSelectSound();
			pauseMusic();
			resourcesManager.setIdMenu(1);
			SceneManager.getInstance().loadFlagGameScene(engine);
			return true;
		
		case MENU_TRANSPORTPLAY:
			playSelectSound();
			pauseMusic();
			resourcesManager.setIdMenu(1);
			SceneManager.getInstance().loadTransportGameScene(engine);
			return true;
