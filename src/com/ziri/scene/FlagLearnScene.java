...
public class FlagLearnScene extends BaseScene implements IOnSceneTouchListener, IOnAreaTouchListener  {
	...
	private void displayImg(int num) {
		...
		case 42:
			...
			break;
		case 43:
			img_044.setVisible(true);
			PageCounter=43;
			imgNumber=43;
			readimgName();
			break;
		case 44:
			img_045.setVisible(true);
			PageCounter=44;
			imgNumber=44;
			readimgName();
			break;
		...
		case 45:
			img_046.setVisible(true);
			PageCounter=45;
			imgNumber=45;
			readimgName();
			break;
		case 46:
			img_047.setVisible(true);
			PageCounter=46;
			imgNumber=46;
			readimgName();
			break;
		case 47:
			img_048.setVisible(true);
			PageCounter=47;
			imgNumber=47;
			readimgName();
			break;
		case 48:
			img_049.setVisible(true);
			PageCounter=48;
			imgNumber=48;
			readimgName();
			break;
		case 49:
			img_050.setVisible(true);
			PageCounter=49;
			imgNumber=49;
			readimgName();
			break;
	...
	public void onBackKeyPressed() {
		...
		resourcesManager.unloadFlagLearnResources();
        PageCounter = 100;
