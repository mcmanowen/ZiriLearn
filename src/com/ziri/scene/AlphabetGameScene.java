...
public class AlphabetGameScene extends BaseScene  implements IOnSceneTouchListener, IOnAreaTouchListener  {
	...
	static final String[] textImgsFr = {"a","b","c", "d","e","f","g","h","i","j","k","l","m", "n","o","p","q","r","s","t","u","v","w", "x","y","z"};
    static final String[] textImgsFrRead = {"a","b","c", "d","eux","f","g","h","i","j","k","l","m", "n","o","p","q","r","s","t","u","v","double v", "x","igrek","z"};
    static final String[] textImgsEn = {"a","b","c", "d","e","f","g","h","i","j","k","l","m", "n","o","p","q","r","s","t","u","v","w", "x","y","z"};
    static final String[] textImgsEnRead = {"a","b","c", "d","e","f","g","h","i","j","k","l","m", "n","o","p","q","r","s","t","u","v","w", "x","why","z"};
...
*/
	...
	private void goMenu() {
		...
		detachChild(gamecompleteHUD);
		pageCounter = 100;
		resourcesManager.unloadAlphabetGameResources();
		//disposeScene();
		}catch(Exception ex){
			ex.printStackTrace();
		}	
	...
	private void readQuestion(int simg){
		...
		if(muteOrNot==false){
			if (localLanguage==0){
			resourcesManager.tts.speak("trouvé la lettre, "+textImgsFrRead[simg],TextToSpeech.QUEUE_FLUSH,null);
			}else if(localLanguage==1){
			resourcesManager.tts.speak("where is letter, "+textImgsEnRead[simg],TextToSpeech.QUEUE_FLUSH,null);
			}
		}else{}
	}
