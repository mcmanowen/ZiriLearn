...
public class FlagGameScene extends BaseScene  implements IOnSceneTouchListener, IOnAreaTouchListener  {
    ...
    static final String[] textImgsFr = {"corée du sud","emirats arabes unies","algérie", "afrique du sud","france","japan","portugal","états unis","suisse","belgique","bresil","irlande","canada","tunisie","royaume uni", "iran","afganistan","argentine","italie","australie","sénegal","roumanie","nigéria","grece","bahrein","paraguay","quatar","arabie séoudite","soudan","suede","hollande","marroc","turquie","cuba","irak","finlande","russie","bulgarie","pakistan","chine","liban","palestine","angola","norvège","syrie","ghana","autriche","chili","uganda","uruguay"};
    static final String[] textImgsFrRead = {"corée du sud","émirat arabe uni","algérie", "afrique du sud","france","japon","portugal","états zuni","suisse","belgique","brézil","irlande","canada","tunisie","royaume uni", "iran","afganistan","argentine","italie","australie","sénégal","roumanie","nigéria","gresse","bareyne","paragwaye","katar","arabie séoudite","soudon","suède","hollande","marroc","turquie","cuba","irak","finlande","russie","bulgarie","pakistan","chine","libon","palestine","angola","norvège","syrie","ghana","autriche","chili","ouganda","urugway"};
    static final String[] textImgsEn = {"south korea","united arab emirates","algeria", "south africa","france","japan","portugal","united states","switzerland","belgium","brasil","ireland","canada","tunisia","united kingdom", "iran","afganistan","argentina","italia","australia","senegal","romania","nigeria","grece","bahrein","paraguay","quatar","saoudi arabia","soudan","sweden","hollande","morroco","turkey","cuba","irak","finland","russia","bulgaria","pakistan","china","lebanon","palestine","angola","norway","syria","ghana","austria","chili","uganda","uruguay"};
	...
	public void populateScene() {
		...
		img_050	 = new Sprite(camera.getWidth()/2, camera.getHeight()/2, resourcesManager.img_050TR, vbom); 
...
*/
	...
	private void goMenu() {
		...
		detachChild(gamecompleteHUD);
		pageCounter = 100;
		resourcesManager.unloadFlagGameResources();
		//disposeScene();
		}catch(Exception ex){
			ex.printStackTrace();
		}	
	...
	private void readQuestion(int simg){
		...
		if(muteOrNot==false){
			if (localLanguage==0){
			resourcesManager.tts.speak("trouvé le drapo, "+textImgsFrRead[simg],TextToSpeech.QUEUE_FLUSH,null);
			}else if(localLanguage==1){
			resourcesManager.tts.speak("where is the flag of, "+textImgsEn[simg],TextToSpeech.QUEUE_FLUSH,null);
			}
		}else{}
	}
