...
public class TransportGameScene extends BaseScene  implements IOnSceneTouchListener, IOnAreaTouchListener  {
    ...
    static final String[] textImgsFr = {"bus jaune","voiture bleue","voiture de sport", "camion","voiture rouge","moto de neige","pickup","bus rouge","moto","tracteur","fourgon","bateau","avions de guerre", "train","quad","clark","camion de pompier","vélo","voiture de police","avion vert","tigre"};
    static final String[] textImgsFrRead = {"busse jaune","voiture bleue","voiture de sport", "camion","voiture rouge","moto de neige","pickeuppe","busse rouge","moto","tracteur","fourgon","bateau","avion de guerre", "train","kwade","clark","camion de pompier","vélo","voiture de police","avion vert","tigre"};
    static final String[] textImgsEn = {"yellow bus","blue car","sport car", "truck","red car","snowbike","pickup","red bus","moto","tractor","van","boat","war planes", "train","quad","clark","fire truck","bike","police car","green plane","tiger"};
...
*/
	...
	private void goMenu() {
		...
		detachChild(gamecompleteHUD);
		pageCounter = 100;
		resourcesManager.unloadTransportGameResources();
		//disposeScene();
		}catch(Exception ex){
			ex.printStackTrace();
		}	
