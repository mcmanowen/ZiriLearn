...
public class MusicinstrGameScene extends BaseScene  implements IOnSceneTouchListener, IOnAreaTouchListener  {
...
*/
	...
	private void goMenu() {
		...
		detachChild(gamecompleteHUD);
		pageCounter = 100;
		resourcesManager.unloadMusicinstrGameResources();
		//disposeScene();
		}catch(Exception ex){
			ex.printStackTrace();
		}	
