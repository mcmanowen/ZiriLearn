...
public class ColorLearnScene extends BaseScene implements IOnSceneTouchListener, IOnAreaTouchListener  {
	...
	public void onBackKeyPressed() {
		...
		resourcesManager.unloadColorLearnResources();
        PageCounter = 100;
	...
	public SceneType getSceneType() {
		return SceneType.SCENE_COLORLEARN;
	}
